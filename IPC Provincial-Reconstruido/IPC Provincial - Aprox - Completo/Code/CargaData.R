...
Poblacion = read_excel("Data/POBLACION_PROVINCIA.xlsx")
Centroides = read_excel("Data/CENTROIDE_PROVINCIAS.xlsx")
CiudadProv = read_excel("Data/PROVINCIA_CIUDAD.xlsx")
...
remove(aux)
names(IPC_ciudades) = c("GUAYAQUIL","ESMERALDAS","MACHALA","MANTA",
